...
<body>
    <form method="get">
        <div class="profile-nav">
            ...
            <button id="logout" name="logout" class="btn btn-outline-danger"
                style="display: <?= isset($_SESSION['user']) ? "block" : "none" ?>">Logout</button>
            <h1>Profile</h1>
        </div>
        <div class="main">
            <div class="profile-container">
                <img src="<?= !empty($user['profile_url']) ? "../" . $user['profile_url'] : "../images/avatar.png" ?>">
                <?php if (isset($user)) : ?>
                <div class="user-info">
                    <label>Name</label>
                    </br>
