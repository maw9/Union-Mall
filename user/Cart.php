...
<body>
    <div class="container">
            ...
            <div id="cart-item-<?= $each['id'] ?>" class="row cart-item d-flex align-items-center mt-3 pb-3">
                ...
                <div class="col-2">
                    <div class="item-qty-control">
                        <button class="minus" onClick="on_remove_from_cart(<?= $each['id'] ?>, <?= $each['price'] ?>)"><i class="fa-solid fa-minus"></i></button>
                        <div id="qty-product-<?= $each['id'] ?>"><?= $each['qty'] ?></div>
                        <button class="plus" id="plus-btn-<?= $each['id'] ?>" onClick="on_add_to_cart(<?= $each['id'] ?>, <?= $each['price']; ?>)"><i class="fa-solid fa-plus"></i></button>
                    </div>
                </div>
        ...
        <div class="row cart-footer discount py-4">
            <div class="col-2"></div>
            <div class="col-2"></div>
            <div class="col-1"></div>
            <div class="col-3"><a href="DiscountCoupons.php">Use Offers to get discounts</a></div>
            <div class="col-2">Discount</div>
            <div id="sub-total" class="col-2">0 MMK</div>
        </div>
