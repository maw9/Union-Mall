                ...
                <form class="mt-5">
                    <div class="delivery-container">
                        ...
                        <div class="mb-3 mt-4">
                            ...
                            <div id="emailHelp" class="form-text">We provide free shipping for our beloved customers.
                            </div>
                        </div>
                        <div class="mb-3">
                    ...
                    <div class="payment-container mt-5">
                        ...
                        <div class="mb-3">
                            ...
                            <br>
                            <input type="text" id="expiration-month" placeholder="MM" required>
                            <span>/</span>
                    ...
                    <button type="submit" class="btn btn-dark px-5 py-3 my-5">Place Order</button>
                </form>
